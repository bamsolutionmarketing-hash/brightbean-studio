...
# "none" = no email confirmation required — users can log in immediately after signup.
# Change to "mandatory" in production if you want email verification enforced.
